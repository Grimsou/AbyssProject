...
public class MainMenu : MonoBehaviour
{
	...
	private void Start()
    {
		...
		_previousSceneToLoad = SceneManager.GetActiveScene().buildIndex - 1;
		_backToMenu = SceneManager.GetActiveScene().buildIndex - 2;
	}
	...
	{
		SceneManager.LoadScene(_previousSceneToLoad);
	}
	...
	private int _previousSceneToLoad;
	private int _backToMenu;
}
